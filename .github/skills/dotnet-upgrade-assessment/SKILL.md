...
- `inputMode`: `"solution"` if a solution file was found in Step 4, otherwise `"projects"`
- `paths`: the full path to the solution file, or `{workspace-path}` if using projects mode
